...
<div class="root-body">
    <header>
        ...
        <div class="header-item goals-wrap">
            <span>Production: </span><span id="current-production">{{ $user->currentProdSum() }}</span>
            <div class="graph-wrap">
                <span class="graph-bar" style="width: {{ ($user->currentProdSum() / $user->calculateProd()) * 100  }}%"></span>
            </div>
        </div>
    ...
    <div class="settings-container">
        <div class="settings-wrap">
            <h4 id="settings-header">{{ $user->emp_name }}</h4>
            <div>
                <span>Hours</span>
                <span id="hours-worked-box" contenteditable="true">{{ $user->hoursWorkedToday()  }}</span>
            </div>
            <div>
                <span>Exempt</span>
                <span id="hours-exempt-box">{{ $user->hoursExemptToday() }}</span>
            </div>
            ...
            <div class="metrics-detail">
                <div id="metrics-cat-call" class="metrics-cat">
                    ...
                    <div id="call-proactive" class="entry-wrap">
                        ...
                        <div class="graph-wrap">
                            <span class="number">{{ $user->countActivityTypeById(11) }}</span>
                            <span class="graph-bar" style="{{ $user->metricsGraphWidthForType(11) }}"></span>
                        </div>
                    </div>
                    <div id="call-covert-proactive" class="entry-wrap">
                        ...
                        <div class="graph-wrap">
                            <span class="number">{{ $user->countActivityTypeById(12) }}</span>
                            <span class="graph-bar" style="{{ $user->metricsGraphWidthForType(12) }}"></span>
                        </div>
                    </div>
                    <div  id="call-sony-proactive" class="entry-wrap">
                        ...
                        <div class="graph-wrap">
                            <span class="number">{{ $user->countActivityTypeById(13) }}</span>
                            <span class="graph-bar" style="{{ $user->metricsGraphWidthForType(13)}}"></span>
                        </div>
                    </div>
                    <div id="call-sony-escalation" class="entry-wrap">
                        ...
                        <div class="graph-wrap">
                            <span class="number">{{ $user->countActivityTypeById(14) }}</span>
                            <span class="graph-bar" style="{{ $user->metricsGraphWidthForType(14)}}"></span>
                        </div>
                    </div>
                </div>
                ...
                <div id="metrics-cat-res" class="metrics-cat metric-research">
                    ...
                    <div class="entry-wrap">
                        ...
                        <div class="graph-wrap">
                            <span class="number">{{ $user->countActivityTypeById(15) }}</span>
                            <span class="graph-bar" style="{{ $user->metricsGraphWidthForType(15)}}"></span>
                        </div>
                    </div>
                    <div class="entry-wrap">
                        <div class="entry-label">
                        ...
                        <div class="graph-wrap">
                            <span class="number">{{ $user->countActivityTypeById(16) }}</span>
                            <span class="graph-bar" style="{{ $user->metricsGraphWidthForType(16)}}"></span>
                        </div>
                    </div>
                    <div class="entry-wrap">
                        <div class="entry-label">
                        ...
                        <div class="graph-wrap">
                            <span class="number">{{ $user->countActivityTypeById(17) }}</span>
                            <span class="graph-bar" style="{{ $user->metricsGraphWidthForType(17)}}"></span>
                        </div>
                    </div>
                </div>
                ...
                <div id="metrics-cat-esc" class="metrics-cat metric-escalations">
                    ...
                    <div class="entry-wrap">
                        ...
                        <div class="graph-wrap">
                            <span class="number">{{ $user->countActivityTypeById(1) }}</span>
                            <span class="graph-bar" style="{{ $user->metricsGraphWidthForType(1)}}"></span>
                        </div>
                    </div>
                    <div class="entry-wrap">
                        <div class="entry-label">
                        ...
                        <div class="graph-wrap">
                            <span class="number">{{ $user->countActivityTypeById(2) }}</span>
                            <span class="graph-bar" style="{{ $user->metricsGraphWidthForType(2)}}"></span>
                        </div>
                    </div>
                    <div class="entry-wrap">
                        <div class="entry-label">
                        ...
                        <div class="graph-wrap">
                            <span class="number">{{ $user->countActivityTypeById(3) }}</span>
                            <span class="graph-bar" style="{{ $user->metricsGraphWidthForType(3)}}"></span>
                        </div>
                    </div>
                    <div class="entry-wrap">
                        <div class="entry-label">
                        ...
                        <div class="graph-wrap">
                            <span class="number">{{ $user->countActivityTypeById(4) }}</span>
                            <span class="graph-bar" style="{{ $user->metricsGraphWidthForType(4) }}"></span>
                        </div>
                    </div>
                    <div class="entry-wrap">
                        <div class="entry-label">
                        ...
                        <div class="graph-wrap">
                            <span class="number">{{ $user->countActivityTypeById(5) }}</span>
                            <span class="graph-bar" style="{{ $user->metricsGraphWidthForType(5) }}"></span>
                        </div>
                    </div>
                    <div class="entry-wrap">
                        <div class="entry-label">
                        ...
                        <div class="graph-wrap">
                            <span class="number">{{ $user->countActivityTypeById(6) }}</span>
                            <span class="graph-bar" style="{{ $user->metricsGraphWidthForType(6) }}"></span>
                        </div>
                    </div>
                </div>
                ...
                <div id="metrics-cat-fu" class="metrics-cat metric-follow-ups">
                    ...
                    <div class="entry-wrap">
                        ...
                        <div class="graph-wrap">
                            <span class="number">{{ $user->countActivityTypeById(7) }}</span>
                            <span class="graph-bar" style="{{ $user->metricsGraphWidthForType(7) }}"></span>
                        </div>
                    </div>
                    <div class="entry-wrap">
                        <div class="entry-label">
                        ...
                        <div class="graph-wrap">
                            <span class="number">{{ $user->countActivityTypeById(8) }}</span>
                            <span class="graph-bar" style="{{ $user->metricsGraphWidthForType(8)}}"></span>
                        </div>
                    </div>
                    <div class="entry-wrap">
                        <div class="entry-label">
                        ...
                        <div class="graph-wrap">
                            <span class="number">{{ $user->countActivityTypeById(9) }}</span>
                            <span class="graph-bar" style="{{ $user->metricsGraphWidthForType(9)}}"></span>
                        </div>
                    </div>
                    <div class="entry-wrap">
                        <div class="entry-label">
                        ...
                        <div class="graph-wrap">
                            <span class="number">{{ $user->countActivityTypeById(10) }}</span>
                            <span class="graph-bar" style="{{ $user->metricsGraphWidthForType(10) }}"></span>
                        </div>
                    </div>
                </div>
                ...
                <div id="metrics-cat-box" class="metrics-cat metric-box-kits">
                    ...
                    <div class="entry-wrap">
                        ...
                        <div class="graph-wrap">
                            <span class="number">{{ $user->countActivityTypeById(18) }}</span>
                            <span class="graph-bar" style="{{ $user->metricsGraphWidthForType(18) }}"></span>
                        </div>
                    </div>
                    <div class="entry-wrap">
                        <div class="entry-label">
                        ...
                        <div class="graph-wrap">
                            <span class="number">{{ $user->countActivityTypeById(19) }}</span>
                            <span class="graph-bar" style="{{ $user->metricsGraphWidthForType(19) }}"></span>
                        </div>
                    </div>
                </div>
                ...
                <div id="metrics-cat-email" class="metrics-cat metric-email">
                    ...
                    <div class="entry-wrap">
                        ...
                        <div class="graph-wrap">
                            <span class="number">{{ $user->countActivityTypeById(20) }}</span>
                            <span class="graph-bar" style="{{ $user->metricsGraphWidthForType(20) }}"></span>
                        </div>
                    </div>
                </div>
                    ...
                    <div id="listjs-activity" class="left-slide">
                        ...
                        <div id="activity-table-wrap">
                            <table>
                                ...
                                <tbody class="list">
                                @foreach($user->activitiesEnteredToday as $activity)
                                <tr>
                                    <td class="t_so">{{ $activity->service_order }}</td>
                                    <td class="t_cat">{{ $activity->type->group->name }}</td>
                                    <td class="t_fun">{{ $activity->type->label->name }}</td>
                                    <td class="t_del"><i class="fa fa-trash-o" aria-hidden="true"></td>
                                </tr>
                                @endforeach
                                </tbody>
                            </table>
